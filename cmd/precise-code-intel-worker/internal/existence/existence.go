...
// getChildren function pointer that determines which of the given paths exist in the current git clone.
...
// Exists determines if the given path exists in the current git clone.
